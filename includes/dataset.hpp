...
class Dataset {
    ...
    */
    int EK_bfs(int s, int t, std::vector<int> *parent, std::vector<std::vector<int>>* residualGraph);
...
public:
    ...
    */
     ...
     * @param s Starting node
     * @param t Destination node
     * @return the path between <s> and <t> generated by this algorithm and the maximum capacity of that path
     */
    std::pair<int, std::vector<int>> BFS(int s, int t);
